...
class BlogPostApi
{
     ...
     * @param  string $order_publish_from order_publish_from (optional)
    ...
    {
        list($response) = $this->getBlogPostCollectionWithHttpInfo($site_id, $published, $order_publish_from, $page, $items_per_page);
        return $response;
    }
     ...
     * @param  string $order_publish_from (optional)
     * @param  int $page The collection page number (optional, default to 1)
     * @param  int $items_per_page The number of items per page (optional, default to 30)
     *
     * @throws \EmonsiteApi\ApiException on non-2xx response
     ...
     */
    public function getBlogPostCollectionAsync($site_id, $published = null, $order_publish_from = null, $page = '1', $items_per_page = '30')
    {
        return $this->getBlogPostCollectionAsyncWithHttpInfo($site_id, $published, $order_publish_from, $page, $items_per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getBlogPostCollectionRequest($site_id, $published = null, $order_publish_from = null, $page = '1', $items_per_page = '30')
    {
        // verify the required parameter 'site_id' is set
        if ($site_id === null || (is_array($site_id) && count($site_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_id when calling getBlogPostCollection'
            );
        }
        ...
        // query params
        if ($published !== null) {
            $queryParams['published'] = ObjectSerializer::toQueryValue($published, null);
        }
        // query params
        if ($order_publish_from !== null) {
            $queryParams['order[publishFrom]'] = ObjectSerializer::toQueryValue($order_publish_from, null);
        }
        // query params
        if ($page !== null) {
    ...
    {
        list($response) = $this->getBlogPostItemWithHttpInfo($id, $site_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBlogPostItemAsync($id, $site_id)
    {
        return $this->getBlogPostItemAsyncWithHttpInfo($id, $site_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBlogPostItemRequest($id, $site_id)
    {
        ...
        if ($site_id === null || (is_array($site_id) && count($site_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_id when calling getBlogPostItem'
            );
        }
