...
class EcoSupplierApi
{
    ...
    {
        list($response) = $this->getEcoSupplierCollectionWithHttpInfo($site_id, $page, $items_per_page);
        return $response;
    }
     ...
     */
    public function getEcoSupplierCollectionAsync($site_id, $page = '1', $items_per_page = '30')
    {
        return $this->getEcoSupplierCollectionAsyncWithHttpInfo($site_id, $page, $items_per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getEcoSupplierCollectionRequest($site_id, $page = '1', $items_per_page = '30')
    {
        // verify the required parameter 'site_id' is set
        if ($site_id === null || (is_array($site_id) && count($site_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_id when calling getEcoSupplierCollection'
            );
        }
    ...
    {
        list($response) = $this->getEcoSupplierItemWithHttpInfo($id, $site_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEcoSupplierItemAsync($id, $site_id)
    {
        return $this->getEcoSupplierItemAsyncWithHttpInfo($id, $site_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEcoSupplierItemRequest($id, $site_id)
    {
        ...
        if ($site_id === null || (is_array($site_id) && count($site_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_id when calling getEcoSupplierItem'
            );
        }
