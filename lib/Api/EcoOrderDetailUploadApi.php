...
class EcoOrderDetailUploadApi
{
    ...
    {
        list($response) = $this->downloadEcoOrderDetailUploadItemWithHttpInfo($, $);
        return $response;
    }
     ...
     */
    public function downloadEcoOrderDetailUploadItemAsync($, $)
    {
        return $this->downloadEcoOrderDetailUploadItemAsyncWithHttpInfo($, $)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function downloadEcoOrderDetailUploadItemRequest($, $)
    {
        // verify the required parameter '' is set
        if ($ === null || (is_array($) && count($) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ when calling downloadEcoOrderDetailUploadItem'
            );
        }
        // verify the required parameter '' is set
        if ($ === null || (is_array($) && count($) === 0)) {
        ...
        // query params
        if ($ !== null) {
            $queryParams['site_id'] = ObjectSerializer::toQueryValue($, null);
        }
