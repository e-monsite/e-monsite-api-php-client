...
/**
 * SiteJsonldEcoStoreDelivery Class Doc Comment
 *
 * @category Class
 * @package  EmonsiteApi
 * @author   OpenAPI Generator team
 ...
 */
class SiteJsonldEcoStoreDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Site_jsonld_ecoStoreDelivery';
     ...
     * Sets id
     *
     * @param \EmonsiteApi\Models\SiteJsonld|null $id id
     *
     * @return self
     */
    public function setId($id)
