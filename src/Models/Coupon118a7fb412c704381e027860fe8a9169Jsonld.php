...
/**
 * Coupon118a7fb412c704381e027860fe8a9169Jsonld Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  EmonsiteApi
 ...
 */
class Coupon118a7fb412c704381e027860fe8a9169Jsonld implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Coupon:118a7fb412c704381e027860fe8a9169:jsonld';
    ...
    public const APPLICABLE_ON_CURRENCY = 'currency';
    public const APPLICABLE_ON_PERCENT = 'percent';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['applicableOn'] === null) {
            $invalidProperties[] = "'applicableOn' can't be null";
        }
        $allowedValues = $this->getApplicableOnAllowableValues();
        if (!is_null($this->container['applicableOn']) && !in_array($this->container['applicableOn'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'applicableOn', must be one of '%s'",
                $this->container['applicableOn'],
     ...
     * Sets applicableOn
     *
     * @param string $applicableOn applicableOn
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getApplicableOnAllowableValues();
        if (!in_array($applicableOn, $allowedValues, true)) {
