...
class AuthentificationApi
{
     ...
     *
     * @param  \EmonsiteApi\Models\Credentials $credentials Create new JWT Token (optional)
     *
    ...
    public function postCredentialsItemWithHttpInfo($credentials = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EmonsiteApi\Models\Tokens' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\EmonsiteApi\Models\Tokens' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\EmonsiteApi\Models\Tokens', []),
